...
class StorageService {
  ...
  /// Defaults to (0, true, now) if nothing persisted.
  ...
  static Future<void> saveConfig(ReminderConfig config) async {
    final box = await _settings;
    final json =
        '${config.sedentaryIntervalMinutes}|${config.hydrationIntervalMinutes}|${config.quietMode}|${config.quietStart}|${config.quietEnd}';
